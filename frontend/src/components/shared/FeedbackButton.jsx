...
export default function FeedbackButton() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const emailSubject = feedback.subject || `GroceryTrack Feedback: ${feedback.type}`;
            const emailBody = `
...
---
Sent from GroceryTrack feedback form
            `.trim();
            ...
            toast.error("Failed to send feedback. Please try emailing us directly at hello@grocerytrack.co.uk");
        }
        setLoading(false);
    };
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1">
                            Leave blank for anonymous feedback
                        </p>
                    </div>
                ...
                <div className="text-center pt-2 border-t">
                    <p className="text-xs text-slate-500">
                        ...
                        <a 
                            href="mailto:hello@grocerytrack.co.uk" 
                            className="text-emerald-600 hover:underline"
                        >
                            hello@grocerytrack.co.uk
                        </a>
                    </p>
                </div>
            </DialogContent>
