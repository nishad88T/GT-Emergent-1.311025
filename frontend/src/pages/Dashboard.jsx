...
export default function Dashboard() {
    ...
    const loadData = useCallback(async () => {
        try {
            ...
            const readyCountValue = (receiptData || []).filter(r => 
            ...
            const insightsReady = (receiptData || []).filter(r => {
                const isReviewReady = r.validation_status === 'review_insights'; // Changed from isValidated
