            ...
            <div className="max-w-7xl mx-auto">
                ...
                <Tabs defaultValue="overview" className="w-full">
                    <TabsList className="grid w-full grid-cols-1 md:grid-cols-3 max-w-2xl">
                        ...
                        <TabsTrigger value="monitoring">KPI Dashboard</TabsTrigger> {/* Updated tab name */}
                    </TabsList>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-slate-700 mb-4">
                                    ...
                                    within GroceryTrack. It details when external services (LLMs, OCR, APIs) are invoked and how they
