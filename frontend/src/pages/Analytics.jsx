...
import { Receipt, Budget, User } from "@/api/entities";
...
export default function AnalyticsPage() {
        ...
        try {
            ...
            if (currentUser && currentUser.household_id) {
                ...
                if (activeBudget) {
                    ...
                    setDeepDivePeriods(getBudgetAlignedPeriods(activeBudget, comparisonPreset)); 
                } else {
    ...
    }, [allReceipts, allBudgets, deepDivePeriods]);
                                                    ...
                                                    <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                                                        ...
                                                        <Select value={comparisonPreset} onValueChange={setComparisonPreset}>
                                                            ...
                                                            <SelectContent>
                                                                ...
                                                                <SelectItem value="3-months-ago">vs. 3 Months Ago</SelectItem>
                                                                <SelectItem value="6-months-ago">vs. 6 Months Ago</SelectItem>
                                                                <SelectItem value="year-on-year">Year-on-Year</SelectItem>
                                                                <SelectItem value="2-years-ago">vs. 2 Years Ago</SelectItem>
                                                            </SelectContent>
                                                        </Select>
                                                    </div>
                                                </Card>
                                                ...
                                                {hasSufficientDataForAdvancedAnalysis ? (
                                                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-8">
                                                        ...
                                                        <VolatilityDashboard 
                                                            ...
                                                            comparisonPeriods={deepDivePeriods} 
                                                        />
                                                        <MultiRetailerComparison receipts={deepDiveReceiptsCurrent} loading={loading} />
                                                        
                                                        {/* DISABLED: ONS API calls paused for now */}
                                                        {/* <OfficialInflationChart receipts={allReceipts} loading={loading} /> */}
                                                        
                                                        <PersonalCPITracker receipts={deepDiveReceiptsCurrent} loading={loading} className="xl:col-span-2" />
                                                    </div>
                                                ) : (
