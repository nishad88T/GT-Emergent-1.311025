...
import { Receipt, User, Budget } from "@/api/entities";
...
export default function ShoppingListPage() {
    ...
    const [generating, setGenerating] = useState(false); // Specific loading for AI generation
                    ...
                    <Card className="border-none shadow-lg bg-white/80 backdrop-blur-sm">
                        <CardHeader className="p-3 sm:p-6">
                            <CardTitle className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                                <span className="text-base sm:text-lg">Shopping List</span>
                                {lastGenerated && (
                                        ...
                                        >
                                            ...
                                            {editingItem && editingItem.id === item.id ? (
                                                <div className="flex-1 flex flex-col md:flex-row items-stretch md:items-center gap-2">
                                                    ...
                                                    />
                                                    <Input
                                                        type="text" // Quantity can be text (e.g. "1kg")
                                                ...
                                                <>
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        {item.note && !item.reason && ( // Display old note if no new reason
