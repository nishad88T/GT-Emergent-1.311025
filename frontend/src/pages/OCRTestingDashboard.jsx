                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        {run.status === 'analyzed' && (
                                                            <Button size="sm" variant="outline" onClick={() => {
                                                                ...
                                                                setAnalysisResults({ analysis: run.batch_analysis_summary });
                                                                setView('results');
                                                            }}>
                                ...
                                <CardContent className="flex-1 overflow-auto p-2">
                                    <div className="text-xs">
                                        <div className="mb-2 p-2 bg-slate-50 rounded">
                                            <div><strong>Store:</strong> {currentReceipt.supermarket}</div>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div className="p-4 bg-emerald-50 rounded-lg">
                                        <div className="text-2xl font-bold text-emerald-600">
                                            {(100 - (analysisResults.error_rate || 0)).toFixed(2)}%
                                        </div>
                                ...
                                <div className="pt-6 border-t">
                                    <Button variant="outline" className="w-full">
                                        ...
                                        Create Re-Test (Version {parseFloat(currentTestRun.version || "1.0") + 0.1})
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
